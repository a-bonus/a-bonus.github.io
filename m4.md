...
* **If Necessary:**
  ...
  ![Post-Hoc Tests](/assets/post-hoc.png)
...
* **Test:** Perform the Repeated Measures ANOVA in SPSS.
  * `Hint:` This is found under `Analyze -> General Linear Model -> Repeated Measures`. 
    ...
    ![Repeated Measures Dialog](/assets/repeated-measures.png)
  ...
  ![Repeated Measures Levels](/assets/repeated-measures-levels.png)


* **Interpretation:**
  1. Find Mauchly's Test of Sphericity in the output. Look at the p-value (Sig.).

  ![Mauchly's Test](/assets/mauchly-test.png)
...
![Within-Subjects Effects](/assets/within-subjects.png)
